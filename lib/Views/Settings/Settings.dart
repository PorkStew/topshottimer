                  ...
                  alignment: Alignment.topCenter,
                    child: Column(
                      ...
                      children: <Widget>[
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: (){
                                        setState(() {
                                          if (ParTime>=0.1){
                                            double roundedParTime = double.parse((ParTime).toStringAsFixed(2)) - 0.10;
                                            ParTime = roundedParTime;
                                            //newSenseGlobal = newSense;
                        ...
                        Text(
                          'If the Par time is set to 0.0s it will be turned off.',
                          style: TextStyle(
                            fontSize: 18.0,
                          ),
                        ),
...
setDefaultParTime(double parTime) async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
  await prefs.setDouble('parTime', double.parse((parTime).toStringAsFixed(2)));
  print(parTime);
  print("USER DEFAULT PAR TIME: "+ prefs.getDouble('parTime').toString());
}
